...
async def run_test():
    ...
    try:
        ...
        # Input username 'OSMAN' and password '80841217' and click login.
        frame = context.pages[-1]
        ...
        # Enter valid question text and correct answer, then submit the new question.
        frame = context.pages[-1]
        ...
        # Click on 'Ana Menü' button to navigate to the question list or main menu where questions are listed.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click on Admin Panel to go back to admin interface and verify question list.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div[2]/div').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Input username 'OSMAN' and password '80841217' and click login to access admin panel.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div[3]/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('OSMAN')
        ...
        # Click on 'Ana Menü' button to navigate to main menu or question list to verify the question.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
