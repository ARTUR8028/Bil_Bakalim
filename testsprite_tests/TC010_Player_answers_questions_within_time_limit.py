...
async def run_test():
    ...
    try:
        ...
        # Add a new quiz question and correct answer, then submit it.
        frame = context.pages[-1]
        ...
        # Click 'Ana Menü' button to return to main menu and proceed to game hosting.
        frame = context.pages[-1]
        ...
        # Go back to Admin Panel to add at least one question to enable game hosting.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click on 'Oyun Sunucusu' to start the game hosting server and manage the quiz game.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div[2]/div[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click 'Ana Menü' to return to main menu and then navigate to Admin Panel to add a unique question.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click on 'Admin Paneli' to login and add a unique quiz question.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div[2]/div').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Input username and password, then click login button to access admin panel.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div[3]/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('OSMAN')
        ...
        # Input a unique quiz question and correct answer, then click 'Soru Ekle' to add the question.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div[3]/div/div[2]/div/textarea').nth(0)
        ...
        # Click 'Ana Menü' button to return to main menu and proceed to game server to start quiz hosting.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
